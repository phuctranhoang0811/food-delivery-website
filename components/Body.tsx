...
function Body() {
  ...
  return (
    <section className="py-6 md:py-8">
      {/* Container chung cho cả Mobile và Desktop */}
      <div className="space-y-12">
        <div className="bg-gradient-to-r from-orange-100 via-orange-200 to-orange-400 rounded-3xl p-6 lg:p-10 hide-mobile-padding overflow-hidden relative shadow-lg">
        ...
        <div className="mt-12">
          <div className="flex flex-col lg:flex-row items-center justify-between mb-6 gap-4">
            ...
            {/* Desktop Filters (Hide on very small mobile) */}
